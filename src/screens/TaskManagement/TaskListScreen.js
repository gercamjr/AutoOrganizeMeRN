...
const TaskListScreen = () => {
  ...
  // Update filtered tasks when filterText or tasks changes
  useEffect(() => {
    if (!filterText.trim()) {
          ...
          onPress: async () => {
            ...
            try {
              ...
              if (changes > 0) {
                ...
                Alert.alert(
                  "Info",
                  "Task could not be deleted. It might have already been removed or does not exist."
                );
              }
            } catch (err) {
        ...
        {filteredTasks.length === 0 && !isLoading && (
          <View style={styles.centeredMessageContainer}>
            ...
            <Text style={styles.emptyListText}>
              {error || "No tasks found. Tap 'Add New Task' to get started!"}
            </Text>
            {error && (
              <AppButton
                title="Retry"
